...
const procedures = [
  ...
  },
  {
    title: "استئجار موقع",
    category: "تشغيلي",
    description: "استئجار موقع وتوثيق العقد في منصة إيجار مع تحديد المسؤوليات والوثائق اللازمة.",
    cost: "حسب الموقع",
    documents: ["الهوية الوطنية", "صك الملكية", "تقارير السلامة"],
    link: "https://business.sa/ar/eservices/details/3bad7cc9-e6c1-4753-08d2-08dbf015747a",
    steps: [],
  },
  {
