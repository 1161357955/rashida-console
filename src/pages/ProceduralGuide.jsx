...
const procedures = [
  ...
  },
  {
    title: "استئجار موقع",
    category: "تشغيلي",
    description: "استئجار موقع وتوثيق العقد في منصة إيجار مع تحديد المسؤوليات والوثائق اللازمة. في الإدارة الرشيدة نستهدف تقديم مشاريع برمجيات كخدمة (SaaS) عبر البيئة الرقمية المرخصة من هيئة الاتصالات والفضاء والتقنية.",
    cost: "حسب الموقع",
    documents: ["الهوية الوطنية", "صك الملكية", "تقارير السلامة"],
  ...
  },
  {
    ...
    category: "حكومي",
    description: "استخراج موافقة الدفاع المدني وترخيص السلامة للمنشآت عبر نظام سلامة.",
    cost: "150 ريال",
    documents: [],
    link: "https://998.gov.sa/ar/Page/Services/1/",
    steps: [
      "التقديم على الطلب عبر البوابة",
      "اختيار شركة السلامة",
      "الموافقة المبدئية على الطلب",
      "زيارة شركة السلامة للموقع",
      "تحديد موعد الكشف الميداني",
      "إصدار وطباعة الترخيص",
    ],
  },
  {
    title: "استخراج رخصة البلدية",
    category: "حكومي",
    description: "استخراج رخصة محل تجاري (الرخص المهنية) عبر منصة بلدي.",
    cost: "حسب نوع النشاط والمساحة",
    documents: ["إثبات الهوية", "عقد إيجار ساري", "صورة السجل التجاري", "رخصة البناء", "شهادة إتمام البناء", "كروكي الموقع"],
    link: "https://balady.gov.sa/Services/?id=94",
    steps: [
      "تعبئة نموذج الطلب واستمارة إصدار الرخصة",
      "زيارة المراقب الفني للموقع",
      "إحضار موافقات الجهات ذات العلاقة",
      "تسديد الرسوم المستحقة",
      "طباعة الرخصة واعتمادها",
    ],
  },
  {
